  ...
  return (
    <main className="about-us">
      ...
      <p className="aboutus--text">
        ...
        ser humano, a través del diagnóstico, diseño, coordinación y ejecución
        ...
        cambios hacia la mejora de la calidad vida. Contamos con un equipo
        interdisciplinaria con profesionales especializados en diversas
        disciplinas como{" "}
        <span>
